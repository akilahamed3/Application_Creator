...
class ImplementationTask(BaseModel):
    filepath: str = Field(description="The path to file to be modified")
    task_description: str = Field(description="A detailed description of the task to be performed on the file.")

class TaskPlan(BaseModel):
    implementation_steps: list[ImplementationTask] = Field(description="A list of steps to be taken to perform the task")
